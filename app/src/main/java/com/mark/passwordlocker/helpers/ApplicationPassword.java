...
public final class ApplicationPassword extends SharedPrefsActor {
    ...
    //public static final String LOCK_APP = "com.mark.passwordlocker.helpers.ApplicationPassword.LOCK_APP";
    ...
    private ApplicationPassword(Context context){
        mContext = context;
        lockPassword();
    }
    ...
    private static class Holder{
        private static ApplicationPassword sInstance =
                new ApplicationPassword(MyApplication.getAppContext());
    }
    ...
    public boolean unlockApplication(String password){
    ...
    private void broadcastAppLocked(){
